...
#(
    ...
    //板卡IP地址
    parameter   BOARD_IP    =   {8'd10,8'd19,8'd37,8'd123},
    //板卡端口号
...
(
    ...
    input   wire            eth_rxdv        ,   //PHY芯片输入数据有效信号
    input   wire    [3:0]   eth_rx_data     ,   //PHY芯片输入数据
    input   wire            eth_tx_clk      ,   //PHY芯片发送数据时钟信号
    ...
    output  wire    [3:0]   eth_tx_data     ,   //PHY芯片输出数据
...
ip_receive
#(
    .MAC_BOARD      (BOARD_MAC      ),  //板卡MAC地址
    .IP_BOARD       (BOARD_IP       )   //板卡IP地址
)
ip_receive_inst
(
